...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__dashboard_instance_instance_component__ = __webpack_require__("./src/app/dashboard/instance/instance.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__common_services_instance_service_instance_service__ = __webpack_require__("./src/app/common/services/instance-service/instance.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__dashboard_instance_instance_component__["a" /* InstanceComponent */]
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__common_services_instance_service_instance_service__["a" /* InstanceService */]
            ],
...
var AuthService = /** @class */ (function () {
     ...
     * */
    AuthService.prototype.fnIsLoggedIn = function () {
        return this._token;
    };
...
/***/ "./src/app/common/services/instance-service/instance.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var InstanceService = /** @class */ (function () {
    ...
    InstanceService.prototype.fnGetInstances = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this._http
                .get(__WEBPACK_IMPORTED_MODULE_2__constant__["a" /* Constant */].API_URL + 'account/instances')
                .subscribe(function (response) {
                resolve(response);
            }, function (error) {
                reject(error);
...
/***/ "./src/app/dashboard/instance/instance.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/dashboard/instance/instance.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"instances-dashboard\">\n    <h2 class=\"card-heading\">Instances</h2>\n    <a href=\"#\" data-target=\"add_instance\" class=\"button icon-btn small w-inline-block\">\n        <div class=\"icon\"></div>\n    </a>\n    <div class=\"card\">\n        <div class=\"info-row shadow\" *ngFor=\"let ins of instances\">\n            <div class=\"name-label bold\">{{ins.name}}</div>\n            <div class=\"grey-text\">Used for testing purposes. Do not suspend.</div>\n            <div class=\"stat-block\">\n                <p>Online since: {{ins.created}}</p>\n            </div>\n            <div class=\"hover-menu\">\n                <a href=\"#\" title=\"Start / Stop\" data-target=\"suspend_instance\"\n                   class=\"button btn-round btn-m w-button\"></a>\n                <a href=\"#\" title=\"Settings\" data-target=\"edit_instance\"\n                   class=\"button btn-round btn-m w-button\"></a>\n            </div>\n            <img src=\"assets/images/mini-chart.JPG\" class=\"microchart\">\n        </div>\n    </div>\n</div>\n"

/***/ }),

/***/ "./src/app/dashboard/instance/instance.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InstanceComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_services_instance_service_instance_service__ = __webpack_require__("./src/app/common/services/instance-service/instance.service.ts");
...
var InstanceComponent = /** @class */ (function () {
    function InstanceComponent(_instance) {
        this._instance = _instance;
    }
    InstanceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._instance.fnGetInstances().then(function (response) {
            if (response && !__WEBPACK_IMPORTED_MODULE_2_lodash__["isEmpty"](response.instances)) {
                _this.instances = response.instances;
            }
        });
    };
    InstanceComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/dashboard/instance/instance.component.html"),
            styles: [__webpack_require__("./src/app/dashboard/instance/instance.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__common_services_instance_service_instance_service__["a" /* InstanceService */]])
    ], InstanceComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_services_toastr_service__ = __webpack_require__("./src/app/common/services/toastr.service.ts");
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(_auth, _toastr, _router) {
        this._auth = _auth;
    ...
    HeaderComponent.prototype.fnLogOut = function () {
        ...
        this._auth.fnSignOut()
            .then(function () {
            _this._toastr.fnSuccess('Logged out successfully.');
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__common_services_auth_service_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_2__common_services_toastr_service__["a" /* ToastrService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]])
    ], HeaderComponent);
